...
-- Database: `AdHoc`
--
CREATE DATABASE  IF NOT EXISTS  `AdHoc` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE AdHoc;
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `buildings` (
  `id` varchar(24) collate utf8_general_ci NOT NULL COMMENT 'Building id',
  `re` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Regex to match room codes for this building',
  `info` varchar(128) collate utf8_general_ci NOT NULL COMMENT 'building information',
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Buildings table';
...
CREATE TABLE IF NOT EXISTS `classes` (
  `classname` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Name of class',
  ...
  `info` varchar(80) collate utf8_general_ci default NULL COMMENT 'Class description',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  PRIMARY KEY  (`classname`),
  KEY `optionspace` (`optionspace`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Table of classes';
...
CREATE TABLE IF NOT EXISTS `class_literal_options` (
  `for` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Class on which to apply this option',
  `value` varchar(256) collate utf8_general_ci NOT NULL COMMENT 'Option value',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  KEY `for` (`for`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Literal options for classes';
...
CREATE TABLE IF NOT EXISTS `class_options` (
  `for` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Class on which to apply the option',
  `name` varchar(32) character set ascii collate ascii_bin NOT NULL COMMENT 'Option name',
  `value` varchar(640) collate utf8_general_ci NOT NULL COMMENT 'The value of the option',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  ...
  KEY `for` (`for`),
  KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Option list for classes' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `dhcp_servers` (
  ...
  `info` varchar(80) collate utf8_general_ci NOT NULL COMMENT 'Server description',
  `id` char(1) collate utf8_general_ci NOT NULL COMMENT 'DHCP server id',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='List of dhcp servers';
...
CREATE TABLE IF NOT EXISTS `global_options` (
  ...
  PRIMARY KEY  (`id`),
  KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Table holding options global to the servers' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `groups` (
  `groupname` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Group name',
  `optionspace` varchar(16) character set ascii collate ascii_bin default NULL COMMENT 'Option space',
  `parent_group` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Parent group',
  `info` varchar(80) collate utf8_general_ci default NULL COMMENT 'Information on the group',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  PRIMARY KEY  (`groupname`),
  KEY `optionspace` (`optionspace`),
  KEY `parent_group` (`parent_group`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Table of host groups';
...
CREATE TABLE IF NOT EXISTS `group_literal_options` (
  `for` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Group on which to apply this option',
  `value` varchar(256) collate utf8_general_ci NOT NULL COMMENT 'Option value',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  KEY `for` (`for`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Literal options for groups';
...
CREATE TABLE IF NOT EXISTS `group_options` (
  `for` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Group on which to apply the option',
  `name` varchar(32) character set ascii collate ascii_bin NOT NULL COMMENT 'Option name',
  `value` varchar(640) collate utf8_general_ci NOT NULL COMMENT 'The value of the option',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  ...
  KEY `for` (`for`),
  KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Option list for groups' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `hosts` (
  ...
  KEY `room` (`room`),
  KEY `optionspace` (`optionspace`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='List of hosts';
...
CREATE TABLE IF NOT EXISTS `host_literal_options` (
  `for` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Host on which to apply this option',
  `value` varchar(256) collate utf8_general_ci NOT NULL COMMENT 'Option value',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  KEY `for` (`for`),
  KEY `value` (`value`(255))
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Literal options for hosts';
...
CREATE TABLE IF NOT EXISTS `host_options` (
  `for` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Host on which to apply the option',
  `name` varchar(32) character set ascii collate ascii_bin NOT NULL COMMENT 'Option name',
  `value` varchar(640) collate utf8_general_ci NOT NULL COMMENT 'The value of the option',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  ...
  KEY `for` (`for`),
  KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Option list for hosts' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `networks` (
  `id` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Name of network',
  `authoritative` int(1) NOT NULL default '1' COMMENT 'Whether the network is authoritative or nor',
  `info` varchar(80) collate utf8_general_ci default NULL COMMENT 'Network description',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  PRIMARY KEY  (`id`),
  KEY `optionspace` (`authoritative`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Table of shared networks';
...
CREATE TABLE IF NOT EXISTS `network_options` (
  `for` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Network on which to apply the option',
  `name` varchar(32) character set ascii collate ascii_bin NOT NULL COMMENT 'Option name',
  `value` varchar(640) collate utf8_general_ci NOT NULL COMMENT 'The value of the option',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  ...
  KEY `for` (`for`),
  KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Option list for networks' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `optionspaces` (
  ...
  PRIMARY KEY  (`id`),
  KEY `value` (`value`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Definitions of option spaces' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `option_defs` (
  ...
  KEY `optionspace` (`optionspace`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Option definitions' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pools` (
  `poolname` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Name of pool',
  `optionspace` varchar(16) character set ascii collate ascii_bin default NULL COMMENT 'Option space, if any',
  `network` varchar(64) collate utf8_general_ci default NULL COMMENT 'Network the pool belongs to',
  `info` varchar(80) collate utf8_general_ci default NULL COMMENT 'Pool description',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  PRIMARY KEY  (`poolname`),
  KEY `optionspace` (`optionspace`),
  KEY `network` (`network`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Table of pools';
...
CREATE TABLE IF NOT EXISTS `pool_class_map` (
  `poolname` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Pool where the host may live',
  `classname` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Class name',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  KEY `classname` (`classname`),
  KEY `poolname` (`poolname`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Defines which classes may live in which pools';
...
CREATE TABLE IF NOT EXISTS `pool_group_map` (
  `poolname` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Pool where the group may live',
  `groupname` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Group name',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  KEY `groupname` (`groupname`),
  KEY `poolname` (`poolname`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Defines which groups that may live in which pools';
...
CREATE TABLE IF NOT EXISTS `pool_literal_options` (
  `for` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Pool on which to apply this option',
  `value` varchar(256) collate utf8_general_ci NOT NULL COMMENT 'Option value',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  KEY `for` (`for`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Literal options for pools';
...
CREATE TABLE IF NOT EXISTS `pool_options` (
  `for` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Pool on which to apply the option',
  `name` varchar(32) character set ascii collate ascii_bin NOT NULL COMMENT 'Option name',
  `value` varchar(640) collate utf8_general_ci NOT NULL COMMENT 'The value of the option',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  ...
  KEY `for` (`for`),
  KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Option list for pools' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pool_ranges` (
  `pool` varchar(64) collate utf8_general_ci NOT NULL COMMENT 'Name of pool this range belongs to',
  ...
  `served_by` char(1) collate utf8_general_ci NOT NULL default 'A' COMMENT 'DHCP server serving this range',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Table IP ranges for pools';
...
CREATE TABLE IF NOT EXISTS `rooms` (
  `id` varchar(10) collate utf8_general_ci NOT NULL COMMENT 'Room ID',
  `info` varchar(80) collate utf8_general_ci default NULL COMMENT 'Room description',
  `printers` varchar(1024) collate utf8_general_ci default NULL COMMENT 'Printer list, if any',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'time of last change',
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='List of defined rooms';
...
CREATE TABLE IF NOT EXISTS `subnetworks` (
  ...
  `network` varchar(64) collate utf8_general_ci default NULL COMMENT 'Network the subnetwork belongs to',
  `info` varchar(80) collate utf8_general_ci default NULL COMMENT 'Subnetwork description',
  `changed_by` varchar(8) character set ascii collate ascii_bin NOT NULL COMMENT 'Cid of last changer',
  `mtime` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP COMMENT 'Time of last change',
  PRIMARY KEY  (`id`),
  KEY `network` (`network`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Table of sub-networks';
...
CREATE TABLE IF NOT EXISTS `subnetwork_options` (
  ...
  KEY `for` (`for`),
  KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Option list for subnetworks' AUTO_INCREMENT=1 ;
